...
http://strm112.1.fm/back280s_mobile_mp3)
	...
	-pointsize 12 -font FjallaOne -draw "text 0,-21 'ouvindo:  1.FM BACK TO THE 80s'" \
...
http://139.162.14.151:9090/stream/1/)
	...
	tail -n 1 /dev/shm/musica | tr '/' '|' | sed "s/'/’/g" | sed "s/STREAMURL//g" | tr -d \; | tr -d \= | tr -d \. | while IFS=$'\n' read line; do
	sudo convert -size 350x60 xc:none -fill white -gravity west \
	-pointsize 12 -font FjallaOne -draw "text 0,-21 'ouvindo:  RADIO SYNTHWAVE RETROWAVE'" \
	-fill LawnGreen -pointsize 14 -font FjallaOne -draw "text 0,1 '$line'" /dev/shm/MUSICA/"$line".png &&
...
http://jfm1.hostingradio.ru:14536/rock80.mp3)
	...
	tail -n 1 /dev/shm/musica | tr '/' '|' | sed "s/'/’/g" | sed "s/STREAMURL//g" | tr -d \; | tr -d \= | tr -d \. | while IFS=$'\n' read line; do
	sudo convert -size 350x60 xc:none -fill white -gravity west \
	-pointsize 12 -font FjallaOne -draw "text 0,-21 'ouvindo:  RADIO ROCK FM 80s'" \
	-fill LawnGreen -pointsize 14 -font FjallaOne -draw "text 0,1 '$line'" /dev/shm/MUSICA/"$line".png &&
...
http://104.247.221.130:9020/stream1)
	...
	tail -n 1 /dev/shm/musica | tr '/' '|' | sed "s/'/’/g" | sed "s/STREAMURL//g" | tr -d \; | tr -d \= | tr -d \. | while IFS=$'\n' read line; do
	sudo convert -size 350x60 xc:none -fill white -gravity west \
	-pointsize 12 -font FjallaOne -draw "text 0,-21 'ouvindo:  RADIO 80 FM'" \
	-fill LawnGreen -pointsize 14 -font FjallaOne -draw "text 0,1 '$line'" /dev/shm/MUSICA/"$line".png &&
...
http://strm112.1.fm/partyzone90s_mobile_mp3)
	...
	tail -n 1 /dev/shm/musica | tr '/' '|' | sed "s/'/’/g" | sed "s/STREAMURL//g" | tr -d \; | tr -d \= | tr -d \. | while IFS=$'\n' read line; do
	sudo convert -size 350x60 xc:none -fill white -gravity west \
	-pointsize 12 -font FjallaOne -draw "text 0,-21 'ouvindo:  1.FM ABSOLUTE 90s PARTY ZONE'" \
	-fill LawnGreen -pointsize 14 -font FjallaOne -draw "text 0,1 '$line'" /dev/shm/MUSICA/"$line".png &&
...
sudo rm -f /dev/shm/MUSICA/*
	...
	tail -n 1 /dev/shm/musica | tr '/' '|' | sed "s/'/’/g" | sed "s/STREAMURL//g" | tr -d \; | tr -d \= | tr -d \. | while IFS=$'\n' read line; do
	sudo convert -size 350x60 xc:none -fill white -gravity west \
	-pointsize 12 -font FjallaOne -draw "text 0,-21 'ouvindo:  011.FM TOTALLY 90s'" \
	-fill LawnGreen -pointsize 14 -font FjallaOne -draw "text 0,1 '$line'" /dev/shm/MUSICA/"$line".png &&
...
sudo rm -f /dev/shm/MUSICA/*
	...
	tail -n 1 /dev/shm/musica | tr '/' '|' | sed "s/'/’/g" | sed "s/STREAMURL//g" | tr -d \; | tr -d \= | tr -d \. | while IFS=$'\n' read line; do
	sudo convert -size 350x60 xc:none -fill white -gravity west \
	-pointsize 12 -font FjallaOne -draw "text 0,-21 'ouvindo:  RADIO HEAVY METAL EARS'" \
	-fill LawnGreen -pointsize 14 -font FjallaOne -draw "text 0,1 '$line'" /dev/shm/MUSICA/"$line".png &&
...
sudo rm -f /dev/shm/MUSICA/*
	...
	tail -n 1 /dev/shm/musica | tr '/' '|' | sed "s/'/’/g" | sed "s/STREAMURL//g" | tr -d \; | tr -d \= | tr -d \. | while IFS=$'\n' read line; do
	sudo convert -size 350x60 xc:none -fill white -gravity west \
	-pointsize 12 -font FjallaOne -draw "text 0,-21 'ouvindo:  RADIO SWISS JAZZ'" \
	-fill LawnGreen -pointsize 14 -font FjallaOne -draw "text 0,1 '$line'" /dev/shm/MUSICA/"$line".png &&
...
sudo rm -f /dev/shm/MUSICA/*
	...
	tail -n 1 /dev/shm/musica | tr '/' '|' | sed "s/'/’/g" | sed "s/STREAMURL//g" | tr -d \; | tr -d \= | tr -d \. | while IFS=$'\n' read line; do
	sudo convert -size 350x60 xc:none -fill white -gravity west \
	-pointsize 12 -font FjallaOne -draw "text 0,-21 'ouvindo:  SURF ROCK RADIO'" \
	-fill LawnGreen -pointsize 14 -font FjallaOne -draw "text 0,1 '$line'" /dev/shm/MUSICA/"$line".png &&
...
sudo rm -f /dev/shm/MUSICA/*
	...
	tail -n 1 /dev/shm/musica | tr '/' '|' | sed "s/'/’/g" | sed "s/STREAMURL//g" | tr -d \; | tr -d \= | tr -d \. | while IFS=$'\n' read line; do
	sudo convert -size 350x60 xc:none -fill white -gravity west \
	-pointsize 12 -font FjallaOne -draw "text 0,-21 'ouvindo:  THE HITS'" \
	-fill LawnGreen -pointsize 14 -font FjallaOne -draw "text 0,1 '$line'" /dev/shm/MUSICA/"$line".png &&
...
sudo rm -f /dev/shm/MUSICA/*
	...
	tail -n 1 /dev/shm/musica | tr '/' '|' | sed "s/'/’/g" | sed "s/STREAMURL//g" | tr -d \; | tr -d \= | tr -d \. | while IFS=$'\n' read line; do
	sudo convert -size 350x60 xc:none -fill white -gravity west \
	-pointsize 12 -font FjallaOne -draw "text 0,-21 'ouvindo:  RADIO NINTENDO'" \
	-fill LawnGreen -pointsize 14 -font FjallaOne -draw "text 0,1 '$line'" /dev/shm/MUSICA/"$line".png &&
...
sudo rm -f /dev/shm/MUSICA/*
	...
	tail -n 1 /dev/shm/musica | tr '/' '|' | sed "s/'/’/g" | sed "s/STREAMURL//g" | tr -d \; | tr -d \= | tr -d \. | while IFS=$'\n' read line; do
	sudo convert -size 350x60 xc:none -fill white -gravity west \
	-pointsize 12 -font FjallaOne -draw "text 0,-21 'ouvindo:  RADIO SEGA'" \
	-fill LawnGreen -pointsize 14 -font FjallaOne -draw "text 0,1 '$line'" /dev/shm/MUSICA/"$line".png &&
...
sudo rm -f /dev/shm/MUSICA/*
	...
	tail -n 1 /dev/shm/musica | tr '/' '|' | sed "s/'/’/g" | sed "s/STREAMURL//g" | tr -d \; | tr -d \= | tr -d \. | while IFS=$'\n' read line; do
	sudo convert -size 350x60 xc:none -fill white -gravity west \
	-pointsize 12 -font FjallaOne -draw "text 0,-21 'ouvindo:  RPGAMERS GAME MUSIC RADIO'" \
	-fill LawnGreen -pointsize 14 -font FjallaOne -draw "text 0,1 '$line'" /dev/shm/MUSICA/"$line".png &&
...
sudo rm -f /dev/shm/MUSICA/*
	...
	tail -n 1 /dev/shm/musica | tr '/' '|' | sed "s/'/’/g" | sed "s/STREAMURL//g" | tr -d \; | tr -d \= | tr -d \. | while IFS=$'\n' read line; do
	sudo convert -size 350x60 xc:none -fill white -gravity west \
	-pointsize 12 -font FjallaOne -draw "text 0,-21 'ouvindo:  CLASSIC HITS 109 - THE 70s'" \
	-fill LawnGreen -pointsize 14 -font FjallaOne -draw "text 0,1 '$line'" /dev/shm/MUSICA/"$line".png &&
